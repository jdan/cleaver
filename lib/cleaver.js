...
Cleaver.prototype.renderSlideshow = function () {
  ...
  var slideshow = mustache.render(this.templates.loaded.slides, {
    ...
    // TODO: uglify script.js?
    script: this.resources.loaded.script
  });
  ...
  var style = [
      !this.external.loaded.style && this.resources.loaded.style,
      !this.external.loaded.style && this.resources.loaded.githubStyle,
