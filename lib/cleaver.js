...
Cleaver.prototype._renderSlideshow = function () {
  ...
  var enableMathJax = !!this.metadata.mathjax;
  ...
  var layoutData = {
    ...
    additionalHead: enableMathJax ? '<script src="http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML"></script>' : ''
  };
