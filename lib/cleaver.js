...
function Cleaver(file, templatesDir, resourcesDir) {
  this.file = file

  if (!file) throw "!! Please specify a file to parse";

  helper.TEMPLATES_ROOT_DIR = templatesDir;
  helper.ASSETS_ROOT_DIR = resourcesDir;
 ...
 */
 Cleaver.prototype._renderSlideshow = function () {
  ...
  var slideData = {
    ...
    fullscreen: this.resources.loaded.fullscreen
  };
